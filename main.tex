...
%Additionally, see Figure 3 for two additional good papers: %\cite{davis2021peek} and \cite{moura2021tsuname}. I found these two papers %by first selecting 'related articles' from the \cite{abhishta2019measuring} 

%\subsection{Five Papers with Description}
